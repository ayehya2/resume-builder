                ...
                {awards.map((award, index) => (
                    <div key={index} className="bg-slate-100 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 p-5 space-y-4 shadow-sm transition-all hover:border-slate-300 dark:hover:border-slate-600">
                        <div className="flex justify-between items-center pb-2 border-b border-slate-100 dark:border-slate-700">
                            <h4 className="font-semibold text-slate-800 dark:text-slate-200 uppercase tracking-tight text-sm">Award {index + 1}</h4>
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Award Title</label>
                                <input
                                    type="text"
                                    value={award.title}
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Issuer / Awarder</label>
                            <input
                                type="text"
                                value={award.awarder}
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Summary (optional)</label>
                            <textarea
                                value={award.summary || ''}
